                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        ...
                        <button
                          key={type.id}
                          onClick={() => setUi(prev => ({ ...prev, finalVideo: { ...prev.finalVideo, type: type.id as any } }))}
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      onChange={(e) => setUi(prev => ({ ...prev, finalVideo: { ...prev.finalVideo, modifications: e.target.value } }))}
                  ...
                  {ui.finalVideo.type === 'image_slide' && (
                    <div className="space-y-3 bg-emerald-500/5 border border-emerald-500/20 rounded-2xl p-4">
                      ...
                      <input
                        ...
                        onChange={(e) => setUi(prev => ({ ...prev, finalVideo: { ...prev.finalVideo, slideDuration: Number(e.target.value) } }))}
                      ...
                      <div className="flex items-center justify-between gap-3 pt-1">
                        ...
                        <select
                          ...
                          onChange={(e) => setUi(prev => ({ ...prev, finalVideo: { ...prev.finalVideo, resolution: e.target.value as RenderResolution } }))}
                      ...
                      <div className="flex items-center justify-between gap-3 pt-1">
                        ...
                        <button
                          onClick={() => setUi(prev => ({ ...prev, finalVideo: { ...prev.finalVideo, subtitleEnabled: !prev.finalVideo.subtitleEnabled } }))}
                      ...
                      {ui.finalVideo.subtitleEnabled && (
                        <>
                          ...
                          <input
                            ...
                            onChange={(e) => setUi(prev => ({ ...prev, finalVideo: { ...prev.finalVideo, subtitleMaxChars: Number(e.target.value) } }))}
                          ...
                          <div className="flex items-center justify-between gap-3 pt-1">
                            ...
                            <select
                              ...
                              onChange={(e) => setUi(prev => ({ ...prev, finalVideo: { ...prev.finalVideo, subtitlePreset: e.target.value as SubtitlePreset } }))}
                              className="bg-slate-800 border border-white/10 rounded-lg px-3 py-1.5 text-[10px] text-white outline-none"
                            >
                          ...
                          <div className="flex items-center justify-between gap-3 pt-1">
                            ...
                            <button
                              onClick={() => setUi(prev => ({ ...prev, finalVideo: { ...prev.finalVideo, subtitleWordHighlight: !prev.finalVideo.subtitleWordHighlight } }))}
                          ...
                          <div className="flex items-center justify-between gap-3 pt-1">
                            ...
                            <select
                              ...
                              onChange={(e) => setUi(prev => ({ ...prev, finalVideo: { ...prev.finalVideo, subtitleHighlightStrength: e.target.value as SubtitleHighlightStrength } }))}
                              className="bg-slate-800 border border-white/10 rounded-lg px-3 py-1.5 text-[10px] text-white outline-none"
                            >
                          ...
                          <div className="space-y-1 pt-1">
                            ...
                            <input
                              ...
                              onChange={(e) => setUi(prev => ({ ...prev, finalVideo: { ...prev.finalVideo, subtitleKeywords: e.target.value } }))}
                          ...
                          <div className="flex items-center justify-between gap-3 pt-1">
                            ...
                            <button
                              onClick={() => setUi(prev => ({ ...prev, finalVideo: { ...prev.finalVideo, subtitleUsePerCutKeywords: !prev.finalVideo.subtitleUsePerCutKeywords } }))}
                          ...
                          {ui.finalVideo.subtitleUsePerCutKeywords && ui.finalVideo.slides.length > 0 && (
                            <div className="space-y-2 bg-black/30 border border-white/10 rounded-xl p-3 max-h-40 overflow-y-auto custom-scrollbar">
                              {ui.finalVideo.slides.map(slide => (
                          ...
                          <div className="flex items-center justify-between gap-3 pt-1">
                            ...
                            <select
                              ...
                              onChange={(e) => setUi(prev => ({ ...prev, finalVideo: { ...prev.finalVideo, subtitleEntryAnimation: e.target.value as SubtitleEntryAnimation } }))}
                              className="bg-slate-800 border border-white/10 rounded-lg px-3 py-1.5 text-[10px] text-white outline-none"
                            >
                  ...
                  {ui.finalVideo.type === 'image_slide' && ui.finalVideo.slides.length > 0 && (
                    <div className="space-y-2 bg-black/30 border border-white/10 rounded-2xl p-4 max-h-52 overflow-y-auto custom-scrollbar">
                      ...
                      {ui.finalVideo.slides.map((slide, idx) => (
                        <div key={`${slide.cut}-${idx}`} className="flex items-center gap-3">
                          ...
                          <select
                            value={slide.motion}
                            onChange={(e) => {
                              const motion = e.target.value as SlideMotionType;
                              setUi(prev => ({
                                ...prev,
                                finalVideo: {
                                  ...prev.finalVideo,
                                  slides: prev.finalVideo.slides.map(s => s.cut === slide.cut ? { ...s, motion } : s),
                                },
                              }));
                            }}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button 
                      ...
                      disabled={ui.finalVideo.generating || ui.imageJobs.filter(j => j.imageUrl).length === 0}
                  ...
                  {ui.finalVideo.url ? (
                      ...
                      <div className="w-full aspect-video bg-black rounded-2xl overflow-hidden relative border border-white/10">
                        <AnimatePresence mode="wait">
                          {(() => {
                            ...
                            const animation = SLIDE_MOTION_ANIMATION[active.motion];
                            return (
                              <motion.img
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 max-w-[250px] mx-auto mt-2">생성된 이미지 {ui.imageJobs.filter(j => j.imageUrl).length}개와 TTS 음원을 결합하여 영상을 제작합니다.</p>
                      </div>
                    </>
                  )}
